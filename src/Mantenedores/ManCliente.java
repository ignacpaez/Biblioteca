...
public class ManCliente extends javax.swing.JFrame {
    ...
    private void btnregistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregistrarActionPerformed
        ...
        Cliente cli = new Cliente(rut_cli, nombre, ApellidoP, ApellidoM, fec_nac, tipo_tel, telefono, correo, cod_ciu);
    
        
        String msjAgregar = libroBo.agregar(cli);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
